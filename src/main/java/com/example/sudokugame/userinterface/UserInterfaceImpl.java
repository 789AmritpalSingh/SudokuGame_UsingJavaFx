...
import com.example.sudokugame.problemdomain.Coordinates;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private void drawGridLines(Group root) {
        ...
        while(index<8){
            ...
            Rectangle horizontolLine  = getLine(
                    BOARD_PADDING,
                    xAndY + 64 * index,
                    thickness,
                    BOARD_X_AND_Y
    ...
    private Rectangle getLine(double x,double y, double height,
                              double width){
    ...
    @Override
    public void updateBoard(SudokuGameClass game) {
        for(int xIndex  = 0; xIndex<9;xIndex++){
            for(int yIndex = 0;yIndex<9; yIndex++){
