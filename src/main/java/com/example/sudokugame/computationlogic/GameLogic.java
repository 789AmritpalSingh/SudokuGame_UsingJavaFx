...
import com.example.sudokugame.constants.Rows;
...
import static com.example.sudokugame.problemdomain.SudokuGameClass.GRID_BOUNDARY;

public class GameLogic {
    public static SudokuGameClass getNewGame(){
        return new SudokuGameClass(
                GameState.NEW,
